...
public:
  ...
  RooSpinZero_3D_ZH_pp* PDF;

  ScalarPdfFactoryPPZH(){};
    
  ScalarPdfFactoryPPZH(RooRealVar* h1,RooRealVar* h2,RooRealVar* Phi, RooRealVar *m, RooRealVar *Y,   RooRealVar* mX, int para, bool withAcceptance) {


    // Parameters
    mZ     = new RooRealVar("mZ","mZ",91.188);
    sqrts  = new RooRealVar("sqrts","sqrts",14000.);
    ...
    PDF = new RooSpinZero_3D_ZH_pp("PDF","PDF",*h1,*h2,*Phi,*m,*Y,*sqrts,*mX,*mZ,*R1Val,*R2Val,parameterization,*a1Val,*phi1Val,*a2Val,*phi2Val,*a3Val,*phi3Val,*g1Val,*g2Val,*g3Val,*g4Val,*g1ValIm,*g2ValIm,*g3ValIm,*g4ValIm,*fa2,*fa3,*phia2,*phia3,withAcc);
