...
//#include "/afs/cern.ch/user/u/usarica/work/snowmass2013/src/RooSpinZero_7DComplex_withAccep_withFepspr.h"
...
public:
  ...
  */
  ...
  ScalarPdfFactory_withFepspr(RooRealVar* m1,RooRealVar* m2,RooRealVar* hs,RooRealVar* h1,RooRealVar* h2,RooRealVar* Phi,RooRealVar* Phi1,RooRealVar* mZZ, int para, bool acceptance, bool pmf_applied=false) {
