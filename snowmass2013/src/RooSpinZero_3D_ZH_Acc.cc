...
enum parameterizationList {kMagPhase_As=0,kRealImag_Gs=1,kFracPhase_Gs=2,kNUMparameterizations=3};
 ...
 ClassImp(RooSpinZero_3D_ZH_Acc) 

 RooSpinZero_3D_ZH_Acc::RooSpinZero_3D_ZH_Acc(const char *name, const char *title, 
				      RooAbsReal& _h1,
				      RooAbsReal& _h2,
				      RooAbsReal& _Phi,
				      RooAbsReal& _sqrts,
 ...
 RooSpinZero_3D_ZH_Acc::RooSpinZero_3D_ZH_Acc(const RooSpinZero_3D_ZH_Acc& other, const char* name) :  
 ...
 Double_t RooSpinZero_3D_ZH_Acc::evaluate() const 
 { 
...
Double_t RooSpinZero_3D_ZH_Acc::analyticalIntegral(Int_t code, const char* rangeName) const
{
...
vector<TLorentzVector> RooSpinZero_3D_ZH_Acc::Calculate4Momentum(float Mx,float M1,float M2,float theta,float theta1,float theta2,float _Phi1_,float _Phi_) const 
{
