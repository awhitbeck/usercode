...
public:
  ...
  ScalarPdfFactoryZH(RooRealVar* hs,RooRealVar* h1,RooRealVar* h2,RooRealVar* Phi,RooRealVar* Phi1, RooRealVar* mX, int para) {


    // Parameters
    mZ     = new RooRealVar("mZ","mZ",91.188);
    sqrts  = new RooRealVar("sqrts","sqrts",250.);
