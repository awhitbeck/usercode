...
class datacardClass:
	...
	#------------------------------------------------end bIncludingError 
        ...
        if theMEKD:
            ...
            ggHtemplate = MEKDshape(self.theInputs,self.channel,self.sqrts,MEKD,CMS_zz4l_mass,True,"sig_ggH")
            VBFtemplate = MEKDshape(self.theInputs,self.channel,self.sqrts,MEKD,CMS_zz4l_mass,True,"sig_VBF")
            WHtemplate  = MEKDshape(self.theInputs,self.channel,self.sqrts,MEKD,CMS_zz4l_mass,True,"sig_WH")
            ZHtemplate  = MEKDshape(self.theInputs,self.channel,self.sqrts,MEKD,CMS_zz4l_mass,True,"sig_ZH")
            ttHtemplate = MEKDshape(self.theInputs,self.channel,self.sqrts,MEKD,CMS_zz4l_mass,True,"sig_ttH")
	...
	bkg_zjetsErr = ROOT.RooProdPdf("bkg_zjetsErr","bkg_zjetsErr", ROOT.RooArgSet(bkg_zjets), ROOT.RooFit.Conditional(ROOT.RooArgSet(pdfErrB), ROOT.RooArgSet(CMS_zz4l_massErr)));
      ...
      ## ----------------- 2D BACKGROUND SHAPES --------------- ##
        ...
        if theMEKD:
            ...
            qqZZtemplate = MEKDshape(self.theInputs,self.channel,self.sqrts,MEKD,CMS_zz4l_mass,False,"qqZZ")
            ggZZtemplate = MEKDshape(self.theInputs,self.channel,self.sqrts,MEKD,CMS_zz4l_mass,False,"ggZZ")
