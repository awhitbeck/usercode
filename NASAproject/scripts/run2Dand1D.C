...
void run2Dand1D(double intLumi=20.0){
  ...
  t->Add("../datafiles/SMHiggs_125_JHU_v2_wResolution_withDiscriminants.root");
  t->Add("../datafiles/SMHiggs_125_JHU_wResolution_withDiscriminants.root");
  TFile* bkgFile = new TFile("../datafiles/EWKZZ4l_Powheg_total_v9_wResolution_withDiscriminants.root");
