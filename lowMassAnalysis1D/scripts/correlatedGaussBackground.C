...
void correlatedGaussBackground(char* fileName="../dataFiles/forMatthew/summer11_data_lowmass.root",double lowMassCut=120, double highMassCut=170, int mH=150){
  ...
  sprintf(inWorkspace,"Test_v2_Workspace_%i.root",mH);
  char outWorkspace[100];
  sprintf(outWorkspace,"Final_v2_2DWorkspace_%i.root",mH);
